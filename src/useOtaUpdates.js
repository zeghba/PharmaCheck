 ...
 * floor between checks so a user flicking between apps does not hammer the
 * update server. Every failure is non-fatal: an unreachable server or an
 * offline device simply leaves the app on the bundle it already has.
 */
