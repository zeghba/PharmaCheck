 ...
 *
 * Restarting is the user's call and always will be: this app provisions and
 * deletes databases, so a bundle swapping itself in mid-task is the one thing
 * the update system must never do.
 */
    ...
    >
      <View style={styles.card}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.body}>Restart PharmaCheck Admin to apply the latest version.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: 'rgba(7, 27, 48, 0.96)',
    borderRadius: 16,
    paddingVertical: 14,
